...
class CameraMovementWhipPanShotScene(sceneManager: SceneManager): Scene(
    "Camera Movement Whip Pan Shot",
    sceneManager = sceneManager,
    clearColor = Color.GRAY,
    defaultPanelCaption = "Creator panel",
    defaultPanelLeft = -1500f,
    defaultPanelBottom = -2500f,
    defaultPanelDimension = 11500f,
    ...
    override val composer = composerOf(
        ...
        autoStart = false,
        initialTimeline = WhipPanShotCameraMovement(
            this,
            cameraController,
            this.defaultPanel,
            instructionHint
    ...
    private var selection: KClass<*> = WhipPanShotCameraMovement::class
